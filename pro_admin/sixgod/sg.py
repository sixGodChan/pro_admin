...
class SixGodUser(v1.BaseSixGodAdmin):
    # table 操作（编辑、删除）
    ...
    # table 显示字段
    list_display = [checkbox_func, 'id', 'username', 'password', 'email', 'role', option_func]


v1.site.register(models.User, SixGodUser)
...
class SixGodRole(v1.BaseSixGodAdmin):
    ...
    list_display = [checkbox_func, 'id', 'caption', 'permissions', option_func]


v1.site.register(models.Role, SixGodRole)


class SixGodMenu(v1.BaseSixGodAdmin):
    # table 操作（编辑、删除）
    def option_func(self, obj=None, is_header=False):
        if is_header:
            return '操作'
    ...
    # table 显示字段
    list_display = [checkbox_func, 'id', 'caption', 'parent', option_func]


v1.site.register(models.Menu, SixGodMenu)

class SixGodPermission(v1.BaseSixGodAdmin):
    # table 操作（编辑、删除）
    def option_func(self, obj=None, is_header=False):
        if is_header:
            return '操作'
    ...
    # table 显示字段
    list_display = [checkbox_func, 'id', 'caption', 'url', 'menu', option_func]


v1.site.register(models.Permission, SixGodPermission)
